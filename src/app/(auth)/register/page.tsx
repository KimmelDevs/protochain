    ...
    <div className="relative min-h-screen flex items-center justify-center px-4 pt-20 pb-8">
      ...
      <div className="backdrop-blur-md shadow-xl rounded-2xl w-full max-w-md p-8 space-y-6 border border-white/20 bg-white/5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* 🔐 Password Tips Trigger */}
          <div
            className="flex items-center gap-2 cursor-pointer text-gray-300 text-sm"
          ...
          >
            ...
            <span className="text-xs text-gray-400 hover:text-white hover:drop-shadow-md cursor-pointer">
          ...
          {/* 🔐 Password Tips Box */}
          {showTips && (
            <div className="bg-white/10 border border-white/20 rounded-lg p-3 text-xs text-gray-300 space-y-1">
