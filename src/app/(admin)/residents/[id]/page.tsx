          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.14 }}
              ...
              <div>
                ...
                {[
                  { label: 'Total',    value: stats.total,    cls: 'text-[#1A1A1C] dark:text-[#EAEAEC]',      border: 'border-[#1A1A1C] dark:border-[#EAEAEC]' },
                  { label: 'Approved', value: stats.approved, cls: 'text-emerald-600 dark:text-emerald-400',  border: 'border-emerald-500' },
                  { label: 'Pending',  value: stats.pending,  cls: 'text-[#92600A] dark:text-[#F5C06A]',      border: 'border-amber-500' },
