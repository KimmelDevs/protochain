                ...
                {isAuthentic && (
                  <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-6">
                      ...
                      <div>
                        <p className="mono text-[10px] font-bold tracking-[0.15em] uppercase text-[#6C6C74] dark:text-[#9090A0] mb-1">Valid Until</p>
                      ...
                      <div>
                        <p className="mono text-[10px] font-bold tracking-[0.15em] uppercase text-[#6C6C74] dark:text-[#9090A0] mb-1">Status</p>
                ...
                {isExpiredDoc && (
                  <>
                    <div className="flex items-center gap-3 mb-4">
                      <ShieldAlert className="w-7 h-7 text-red-500 dark:text-red-400 shrink-0" />
                      <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        <p className="mono text-[10px] font-bold tracking-[0.15em] uppercase text-[#6C6C74] dark:text-[#9090A0] mb-1">Expired On</p>
