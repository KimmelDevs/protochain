...
export default function ReportsPage() {
  ...
  const statCards = [
    { label: 'Total Requests', value: total, icon: FileText, color: 'from-blue-500 to-blue-600', change: null },
    { label: 'Approved', value: approved, icon: CheckCircle, color: 'from-green-500 to-green-600', change: null },
    { label: 'Pending', value: pending, icon: Clock, color: 'from-yellow-500 to-yellow-600', change: null },
    { label: 'Residents', value: residentCount, icon: Users, color: 'from-purple-500 to-purple-600', change: null },
  ];
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">View statistics and generate reports</p>
            </div>
                      ...
                      <div key={item.type}>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-medium text-white w-6 text-right">{item.count}</span>
                          </div>
                        </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  {monthlyData.map(data => (
                    <div key={data.month}>
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm font-medium text-white w-16">{data.month}</span>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={s.label} className="text-center p-6 bg-white/5 rounded-lg">
