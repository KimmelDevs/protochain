            ...
            return (
              <div key={s.label} className={`${s.bg} border ${s.border} rounded-xl p-5`}>
                <div className="flex items-center justify-between mb-4">
                  <div className={`bg-gradient-to-r ${s.color} p-2.5 rounded-lg`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              {!loading && total > 3 && (
                <Link href="/my-requests" className="text-sm text-blue-400 hover:text-blue-300 flex items-center gap-1">
            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {recent.map((req) => {
                  ...
                  return (
                    <div key={req.id} className="bg-white/5 border border-white/10 rounded-lg p-4 hover:border-blue-500/30 transition-all">
                      <div className="flex items-center justify-between">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-2">
                            <FileText className="w-5 h-5 text-blue-400 shrink-0" />
                            <h3 className="font-semibold text-white truncate">{req.type ?? req.document_type}</h3>
                          </div>
