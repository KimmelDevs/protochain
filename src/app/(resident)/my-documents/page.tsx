    ...
    <div className="min-h-screen p-4 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">My Documents</h1>
          <p className="text-gray-400">View and download your approved barangay documents</p>
        </motion.div>
        ...
        >
          {documents.length === 0 && (
            <div className="col-span-full">
              <div className="bg-white/5 border border-white/10 rounded-xl p-12 text-center">
                ...
                <p className="text-gray-400 mb-2">You don't have any approved documents yet.</p>
                <p className="text-sm text-gray-500 mb-8">Once your request is approved, it will appear here.</p>
          ...
          {filtered.map((doc) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-white mb-3">{doc.type ?? doc.document_type}</h3>

              <div className="space-y-2 mb-4">
                <p className="text-xs font-mono text-gray-500">{doc.id.slice(0, 8).toUpperCase()}</p>
